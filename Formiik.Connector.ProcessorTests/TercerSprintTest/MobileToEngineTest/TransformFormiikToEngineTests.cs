...
namespace Formiik.Connector.ProcessorTests.TercerSprintTest.MobileToEngineTest
{
    ...
    {
        private const string FULL_RESPONSE_XML = "TercerSprintTest/Resources/FullResponse.xml";
        ...
        [Fact]
        public void SolCreNor_TransformFlexibleUpdate_Test()
        {
            TransformFlexibleUpdate_Test(TercerSprintTestConstants.SolCreNor);
        }

        [Fact]
        public void TransformResponse_SolCreNor_Test()
        {
            TransformResponseSection_Test(TercerSprintTestConstants.SolCreNor);
        }
